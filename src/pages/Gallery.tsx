      ...
      <div className="relative z-10">
        <main className="max-w-7xl mx-auto px-4 py-12 pt-24">
          ...
          <Tabs defaultValue="photos" className="w-full">
            <TabsList className="grid w-full grid-cols-2 bg-purple-dark/50 border border-gold/30 rounded-lg mb-8">
              <TabsTrigger
                value="photos"
                className="text-gold data-[state=active]:bg-gold/20 data-[state=active]:text-white transition-all duration-300"
              >
                Photos
              </TabsTrigger>
              <TabsTrigger
            ...
            <TabsContent value="videos">
              <div className="flex justify-center items-center w-full h-full min-h-[300px] sm:min-h-[400px] md:min-h-[500px] lg:min-h-[600px] xl:min-h-[700px]">
                <iframe
                  className="w-full h-full aspect-video rounded-lg shadow-2xl border border-gold/30"
                  src="https://www.youtube.com/embed/playlist?list=PL_tWJSjNQ40pFXN77sWYiqQW2nXSlppa6&autoplay=1&loop=1&mute=0&controls=1&modestbranding=1&rel=0"
